      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 md:order-2 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
            Hi, I'm <span className="bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent">Archford</span>
          </h1>
          <h2 className="text-xl md:text-2xl text-slate-300 mb-6">
            Full Stack Developer & UI/UX Enthusiast
          </h2>
          <p className="text-slate-400 mb-8 leading-relaxed">
            I create digital experiences that are fast, accessible, and visually appealing. 
            With a passion for both design and development, I bridge the gap between aesthetics and functionality.
          </p>
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300">
              Download CV
            </button>
            <button className="px-6 py-3 border border-slate-700 text-slate-300 rounded-lg font-medium hover:border-blue-500 hover:text-blue-400 transition-all duration-300">
              My Projects
            </button>
          </div>
        </div>
