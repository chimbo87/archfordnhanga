          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 flex justify-center">
              <div className="relative">
                ...
                <div className="relative w-72 h-72 sm:w-80 sm:h-80">
                  ...
                  <div
                    className="absolute inset-0 bg-gradient-to-br from-emerald-400 to-blue-400 rounded-2xl transform -rotate-6 opacity-20 animate-pulse"
            ...
            <div className="order-1 lg:order-2 space-y-8">
              <p className="text-lg leading-relaxed text-slate-300">
                ...
                web technologies. With a strong foundation in computer science
                and hands-on experience in building scalable applications, I
